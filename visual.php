...
<?php
        ...
        <div calss="col-xs-12">
            ...
            <a href="recebido.php?id=<?php echo $idpedido; ?>" class="btn btn-primary hidden-print">Receber Pedido</a>
            <a href="recusado.php?id=<?php echo $idpedido; ?>" class="btn btn-danger hidden-print">Recusar Pedido</a>
        </div>
<?php
    include "rodape.html";
?>
